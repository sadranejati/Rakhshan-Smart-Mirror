...
labelPrompt = Label(frmPrompt,text='سلام! من رخشان هستم، یه آینه هوشمند! دوست داری بیشتر راجع بهم بدونی؟',font=('IRANSans-Medium', 35), background='black', foreground='white',wraplength=1000)
